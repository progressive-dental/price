        ...
        <div class="vc_col-sm-12">
          <div class="headline headline--center">
            <h2 class="headline__main  headline__cta  text-light">
              Book Your <strong>Consultation</strong>
            </h2>
            <a class="btn btn--outline-light" href="/contact-us" title="Inquire Now">
              Inquire Now
            </a>
          </div>
        </div>
  ...
  <div class="container-fluid">
    ...
    <div class="col-md-6">
      <div class="site-foot__column  site-foot__column--center">
        <span class="site-foot__header">Explore Our Site</span>
        <?php
        wp_nav_menu(
          array(
    ...
    <div class="col-md-3">
      <div class="site-foot__column  site-foot__column--right">
        <?php if( $progressive['enable-location-two'] == 0)  : ?>
            ...
            <?php if( $progressive['enable-new-patient-number'] == 1 ) : ?>
              <li class="contact-list__item">
                <?php if( $progressive['enable-ppc'] == 1 ) : ?>
                  For Inquiries: <a href="+1-<?php echo localize_us_number( $progressive['new-patient-number'] ); ?>" class="site-foot__link  site-foot__link--phone  clickToCall" data-call-tracking-number="<?php echo localize_us_number( $progressive['new-patient-number'] ); ?>" data-ppc-tracking-number="<?php echo $progressive['ppc-number']; ?>"><span class="webPpcNumber"><?php echo $progressive['ppc-number']; ?></span></a>
                <?php else : ?>
                  For Inquiries: <a class="site-foot__link  site-foot__link--phone" href="tel:+1-<?php echo localize_us_number( $progressive['new-patient-number'] ); ?>"><?php echo $progressive['new-patient-number']; ?></a>
                <?php endif; ?>
              </li>
            <?php endif; ?>
          ...
          <a href="<?php echo get_permalink( $progressive['contact-us-link'] ); ?>" class="btn btn--outline-light btn--small">Contact Us</a>
        <?php else : ?>
